...
Guidance for AI coding agents working in this repository. The project design doc is `PLATEPACKER_SEED.md`; Claude Code-specific guidance is in `CLAUDE.md`.
...
- **key_facts.md** - Project configuration, constants, conventions, important URLs
...
- Check `docs/project_notes/key_facts.md` for constants, conventions, and config
