...
- **Raft-fusion packing (ADR-015)**: fused ⇔ body ≠ full (derived in `_pack_bounded` by mask comparison); fused bodies may nest over fused rafts, non-fused pieces stay strict full-shadow; plate boundary always uses the full.
